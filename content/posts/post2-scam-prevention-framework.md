+++
title = "What's Scam Prevention Framework"
...
tags = ["scams", "spf", "regulation", "telcos", "australia", "consumer-protection"]
# bookComments: false
...
1. Scammers get personal information from someone (to take over accounts)
2. Scammers convince someone to transfer money directly to them
...
1. **Stop scams before they happen** (PREVENT)
2. **Spot suspicious stuff faster** (DETECT)
3. **Shut scams down quickly** (DISRUPT)
4. **Help victims recover** (RESPOND)
5. **Share what they learn** (REPORT)
